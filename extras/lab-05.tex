...
\item \textbf{Clone} the \texttt{lecture-06} repository from GitHub using GitHub Desktop.\sidenote{If you are not sure where your GitHub Desktop data has download to on the computer, you can \textsf{right click} on the repo's entry in GitHub Desktop and have it take you to the repo in Windows File Explorer. By default, this should be within your \texttt{Documents/} directory.}
\end{enumerate}
